                    ...
                    <ul class="nav navbar-nav">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
						...
						else
							{
									...
									echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link active">Pemesanan</a> </li>';
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                ...
                <h2>Best Menu Bulan Ini</h2>
                <p class="lead">Langkah yang mudah untuk pesan top 6 menu Warkop Santai</p>
            </div>
            <div class="row">
        ...
        <div class="container">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Pilih Warkop Santai</h3>
                                <p>Di Warkop Santai kalian bisa memilih beragam varian menu yang ditawarkan.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Pilih Menu</h3>
                            <p>Pilih menu yang kalian suka disini</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Ambil atau Diantar</h3>
                            <p>Dapatkan segera pesananmu! Enjoy! </p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">Bayar di tempat</p>
                </div>
            </div>
        </div>
    </section>
